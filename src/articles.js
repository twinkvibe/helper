...
export async function renderPublicArticle(host, client, slug) {
 ...
 host.innerHTML = '<main class="public-article"><header class="public-header"><a class="brand" href="./">h<span>elper</span><i>✳</i></a><a class="quiet" href="./">Войти</a></header><article class="article-paper"><header class="article-title"><h1></h1><div class="article-byline"></div></header><div class="article-cover article-cover-empty"></div><div class="article-body"></div></article></main>';
